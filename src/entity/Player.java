...
//	public int hasKey = 0;
	...
	public void setItems() {
		...
		inventory.add(new OBJ_Doran_Sword(gp));
...
//	}
	...
	public void update() {
		...
		else if(keyH.upPressed == true || keyH.downPressed == true || keyH.leftPressed == true || keyH.rightPressed ==true || keyH.enterPressed ==true)
		{
			...
			int iTileIndex = gp.cChecker.checkEntity(this, gp.iTile, true);
			...
			//set them de khi bam enter khong move dc
		...
		if(gp.keyH.shotKeyPressed == true && projectile.alive == false && shotAvailableCounter == 30 && projectile.haveResource(this) == true) {
			...
			//SET UP PROJECTILE (toa do, huong, nguoi dung)
			///Cai nay duoc dua tren vi tri cua nguoi choi
			...
			//ADD IT TO THE LIST
			///vi moi dan la 1 thuc the rieng biet, tao ra xong thi add vao list -> lat nua render 1 the
...
//		g2.fillRect(x, y, gp.tileSize, gp.tileSize);
		...
		BufferedImage image = null;
		//fix loi tan cong len va tan cong ben phai
